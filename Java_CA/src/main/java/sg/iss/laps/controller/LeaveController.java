package sg.iss.laps.controller;
...
//	String startDate, Model model) throws ParseException {		
//		
//		java.time.LocalDate startDateParsed = LocalDate.parse(startDate); 		
//		List<Leave> mls = lservice.findLeavesByYearandMonth
//				(startDateParsed.getYear(), startDateParsed.getMonthValue());
//		List<Leave> mls = lservice.findLeavesByDate(startDateParsed);
//		model.addAttribute("mvtleaves", mls);
//		return "forward:/leave/mvt-reg";
//	}
